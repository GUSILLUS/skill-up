  ...
  return (
    <div className="flex flex-col gap-2 p-4 bg-slate-100 rounded-md">
      ...
      <div className="flex flex-col gap-3 items-center">
        {userName && (
          <Typography className="bg-slate-200 rounded-md w-max p-2 shadow-md hover:shadow-lg hover:translate-y-[-5px] duration-300">
        ...
        <Typography className="bg-slate-200 rounded-md w-10/12 p-2 shadow-md hover:shadow-lg hover:translate-y-[-5px] duration-300 text-center">
          {t('longText')}
        </Typography>
      </div>
    </div>
